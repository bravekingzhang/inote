...
class INoteSlider extends StatefulWidget {
  ...
  @override
  _INoteSliderState createState() => _INoteSliderState();
...
class _INoteSliderState extends State<INoteSlider>
...
const double _kPadding = 1.0;
const Color _kTrackColor = Color(0xFFB5B5B5);
const double _kSliderHeight = 1.0 * (CupertinoThumbPainter.radius + _kPadding);
