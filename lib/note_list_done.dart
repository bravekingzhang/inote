...
class NoteListDone extends StatefulWidget {
  const NoteListDone({
    this.colorItems,
    this.noteListBloc,
    this.homeBloc,
  ...
  @override
  _NoteListDoneState createState() => _NoteListDoneState();
}

class _NoteListDoneState extends State<NoteListDone> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      child: Scaffold(
        body: StreamBuilder(
          stream: widget.noteListBloc.noteListDone,
              ...
              itemBuilder: (BuildContext context, int index) {
                return Slidable.builder(
                    ...
                    secondaryActionDelegate: new SlideActionBuilderDelegate(
                        actionCount: 2,
                        builder:
                            (context, actionIndex, animation, renderingMode) {
                          if (actionIndex == 0) {
